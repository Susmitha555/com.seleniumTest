...
public class HomePage extends TestBase {
	...
	public HomePageRemove clickAddtoCart(String itemName) throws InterruptedException {
		...
		for (WebElement v : itemNames) {
			...
			if (v.getText().equals(itemName)) {
				...
				driver.findElement(By.xpath("(//div[contains(text(),'" + itemName + "')]//following::button)[1]"))
						.click();
				System.out.println("clicked on add to cart for item: " + itemName);
				Thread.sleep(7000);
				break;
